...
namespace blockchainGob.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly blockchainGobDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = blockchainGobConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(blockchainGobDbContext context)
        {
            _context = context;
        }
