...
@Injectable()
export class DemandasServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateDemandasDto | undefined): Observable<DemandasDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DemandasDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DemandasDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<DemandasDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<DemandasDto>(<any>null);
    }
...
export class CreateDemandasDto implements ICreateDemandasDto {
    ...
    static fromJS(data: any): CreateDemandasDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDemandasDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["defendant"] = this.defendant;
        return data; 
    }

    clone(): CreateDemandasDto {
        const json = this.toJSON();
        let result = new CreateDemandasDto();
        result.init(json);
        return result;
...
export interface ICreateDemandasDto {
    applicant: string | undefined;
    defendant: string | undefined;
}


export class DemandasDto implements IDemandasDto {
    applicant: string | undefined;
    defendant: string | undefined;

    constructor(data?: IDemandasDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DemandasDto {
        data = typeof data === 'object' ? data : {};
        let result = new DemandasDto();
        result.init(data);
        return result;
    }
