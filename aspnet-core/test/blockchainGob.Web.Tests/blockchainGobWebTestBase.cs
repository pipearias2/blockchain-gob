...
{
    public abstract class blockchainGobWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static blockchainGobWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(blockchainGobWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<blockchainGobDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<blockchainGobDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<blockchainGobDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<blockchainGobDbContext, Task<T>> func)
        {
            T result;
